package dev.vibessh.metrics.command;
...
import dev.vibessh.metrics.status.ServerStatus;
...
/**
 * {@code /metrics} - a live TPS / MSPT / RAM / per-world report in chat.
 *
...
public final class MetricsCommand {
    ...
    public String report() {
        ...
        return "<gradient:#57c7d8:#8be9fd><b>VibeSSH Metrics</b></gradient> <dark_gray>|</dark_gray> <gray>status</gray>"
    ...
    public String toggleBar(@Context Player player) {
        ...
        return shown
                ? "<green>VibeSSH Metrics:</green> <gray>TPS bar on.</gray>"
                : "<gray>VibeSSH Metrics: TPS bar off.</gray>";
    }

    @Execute(name = "worst")
    public String worst() {
        // Roadmap: rank what is eating the tick (entity / chunk hotspots per world).
        return "<gray>VibeSSH Metrics:</gray> <white>/metrics worst</white> <gray>- coming soon.</gray>";
    }
